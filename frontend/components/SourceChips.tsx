    ...
    <div className={`flex flex-wrap gap-2 ${className ?? ''}`}>
      {sources.map((s, i) => (
        <button
          ...
          className="flex items-center gap-1.5 rounded-full border border-[rgba(30,20,45,0.12)] bg-white px-3.5 py-[7px] text-[12.5px] font-medium text-[#5b5566] transition-colors duration-200 ease-out hover:border-[#6d4bb8]/40 hover:text-[#6d4bb8]"
        >
