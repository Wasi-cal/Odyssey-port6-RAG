    ...
    >
      {onAttach && (
        <button
          ...
          className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full text-[#9a93a8] transition-colors hover:bg-[rgba(138,99,214,0.08)] hover:text-[#6d4bb8]"
        >
