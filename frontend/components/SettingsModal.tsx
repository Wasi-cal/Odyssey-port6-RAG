...
export function SettingsModal({ open, responseStyle, citeSources, onClose, onStyleChange, onToggleCite }: SettingsModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[rgba(35,25,50,0.35)] backdrop-blur-sm">
      <div className="w-[420px] max-w-[90vw] rounded-[18px] border border-[rgba(30,20,45,0.08)] bg-white p-[26px] shadow-2xl">
        <div className="mb-[18px] flex items-center justify-between">
          <span className="text-[20px] font-bold text-[#211f2b]">Settings</span>
          <button onClick={onClose} className="text-[#9a93a8] hover:text-[#211f2b]">
        ...
        <div className="flex items-center justify-between border-t border-[rgba(30,20,45,0.06)] py-3">
          ...
          >
            <div
              className="absolute top-0.5 h-5 w-5 rounded-full bg-white shadow-[0_1px_3px_rgba(0,0,0,0.3)] transition-all"
