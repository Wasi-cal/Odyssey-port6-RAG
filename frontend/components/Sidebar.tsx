 ...
 * buttons alongside the brand row and the New chat button.
 *
 * `collapsed` shrinks this to a 68px icon rail (new chat / documents /
 * settings / expand / avatar only, no history list or text) rather than
 * unmounting anything, so history/session state underneath is untouched.
 */
  ...
  return (
    ...
    >
      ...
      <div className={`flex flex-shrink-0 items-center gap-2 ${collapsed ? 'flex-col px-2' : 'px-4'}`}>
        ...
        {collapsed && (
          <button
            onClick={onOpenSettings}
            title="Settings"
            className="flex h-[38px] w-[38px] flex-shrink-0 items-center justify-center rounded-xl border border-[rgba(30,20,45,0.08)] bg-white text-[#433d55] transition-colors duration-200 ease-out hover:bg-[#faf6fd]"
          >
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <circle cx="12" cy="12" r="3" />
              <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.6 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.6a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z" />
      ...
      <button
        onClick={onLogout}
        title="Sign out"
        className={`flex flex-shrink-0 items-center gap-2.5 border-t border-[rgba(30,20,45,0.06)] py-4 text-left transition-colors duration-200 ease-out hover:bg-[rgba(138,99,214,0.05)] ${
